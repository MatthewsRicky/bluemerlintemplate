...
export default function ContactHero() {
  return (
    <section className="relative min-h-[60svh] overflow-hidden bg-[#082f49] text-white">
      <div className="absolute inset-0">
        <Image
          src="/images/blue-marlin-beach.jpg"
          alt="Blue Marlin Beach Restaurant on Diani Beach"
          fill
          priority
      ...
      <div className="absolute inset-0 bg-gradient-to-t from-[#082f49]/95 via-[#082f49]/25 to-[#082f49]/35" />

      <div className="relative z-10 flex min-h-[60svh] items-end">
        <div className="mx-auto w-full max-w-[1600px] px-5 pb-16 pt-36 sm:px-8 sm:pb-20 lg:px-10 lg:pb-24">
          ...
          <Reveal delay={0.2} y={20}>
            <p className="mt-8 max-w-xl text-sm leading-8 text-white/70 sm:text-base sm:leading-9">
              We're on Diani Beach Road, beside the Indian Ocean.
            </p>
          </Reveal>
        </div>
      </div>
