...
export default function MenuHero() {
  return (
    <section className="relative min-h-[68svh] overflow-hidden bg-[#082f49] text-white">
      <div className="absolute inset-0">
        <Image
          src="/images/blue-marlin-seafood-salad.avif"
          alt="Seafood at Blue Marlin Beach Restaurant"
          fill
          priority
      ...
      <div className="absolute inset-0 bg-gradient-to-t from-[#082f49]/95 via-[#082f49]/30 to-[#082f49]/30" />
          ...
          <div className="max-w-5xl">
            ...
            <Reveal delay={0.2} y={20}>
              <p className="mt-8 max-w-xl text-sm leading-8 text-white/70 sm:text-base sm:leading-9">
                Fresh seafood, sushi, coastal flavours and dishes made for long
                afternoons beside the Indian Ocean.
              </p>
            </Reveal>
          </div>
        </div>
